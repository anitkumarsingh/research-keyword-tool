    ...
    return(
        <div className="content-section">
              ...
              <div className="section group">
                    ...
                    <span style={{fontSize:'25px',color:'#B6B6B6',marginLeft:'65px',marginTop:'-20px'}}>{items[0]["statics-keywords-title"]}</span>
                    <h3 style={{textAlign:'left'}}>{items[0]["header-title"]}</h3>
                    <p style={{textAlign:'justify',lineHeight:'1.5',color:'rgba(51,51,51,0.9)'}}>{items[0].description}</p>
                    </div>
                    <div className="col span_2_of_3">
                    <h1 style={{color:'#B6B6B6',fontSize:'50px'}}>{items[0]["statics-products"]}</h1>
                    <span style={{fontSize:'25px',color:'#B6B6B6',marginLeft:'65px',marginTop:'-20px'}}>{items[0]["statics-products-title"]}</span>
                    <h3 style={{textAlign:'left'}}>{items[0]["header-title"]}</h3>
                    <p style={{textAlign:'justify',lineHeight:'1.5',color:'rgba(51,51,51,0.9)'}}>{items[0].description}</p>
                    </div>
              </div>
