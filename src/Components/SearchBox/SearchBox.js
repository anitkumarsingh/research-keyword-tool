    ...
    return(
          <div className="search-container">
            ...
            <form className="form-container" onSubmit={this.handleSubmit} >
              <input type="text" placeholder="Keyword or ASIN" 
                onChange={event =>this.setState({searchKeywords:event.target.value})}
                
              />
              <button className="search-btn" onClick={this.onSearchChange}>PING</button>
              {' '}
              </form>
            </div>
                {' '}
            ...
            <section id="section10" className="demo">
              <a href="#author" className="author-path"><span></span>About SellerApp</a>
            </section>
          </div>
     )
  }
