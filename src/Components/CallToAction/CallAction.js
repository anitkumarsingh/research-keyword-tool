...
const CallToActionContent = () => {
  ...
  return (
    <div className="content-section1">
      ...
      <p>
        try <span className="sub-title">SellerApp:</span>{' '}
        {items[0]['sub-title']}
      </p>
      ...
      <p>
        No credit card required!. For more information at{' '}
        <a href="#author" style={{ textDecoration: 'none' }}>
          sellerapp.com
        </a>
      </p>
      <h5 className="headerText" id="author">
        {' '}
        &copy; 2018, Coded By Anit Kumar
      </h5>
    </div>
  );
};
